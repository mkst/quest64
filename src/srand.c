...
#pragma GLOBAL_ASM("asm/nonmatchings/srand/func_80023360.s")

#pragma GLOBAL_ASM("asm/nonmatchings/srand/func_80023500.s")

//#pragma GLOBAL_ASM("asm/nonmatchings/srand/func_80023570.s")
void func_80023570(unk23a08s *arg0, f32 arg1, f32 arg2, f32 arg3)
{
  f32 sp4C;
  f32 sp48;
  f32 sp44;
  ...
  sp44 = sinf(arg3);
  temp_f0 = cosf(arg3);
  arg0->unk0 = (f32) ((temp_f0 * sp3C) + ((sp44 * sp4C) * sp48));
  arg0->unk4 = (f32) (sp44 * temp_f20);
  arg0->unk8 = (f32) (((-sp48) * temp_f0) + ((sp44 * sp4C) * sp3C));
  arg0->unkC = 0.0f;
  arg0->unk10 = (f32) (((-sp44) * sp3C) + ((temp_f0 * sp4C) * sp48));
  arg0->unk14 = (f32) (temp_f0 * temp_f20);
  arg0->unk18 = (f32) (((-sp44) * (-sp48)) + ((temp_f0 * sp4C) * sp3C));
  arg0->unk1C = 0.0f;
  arg0->unk20 = (f32) (temp_f20 * sp48);
  arg0->unk24 = (f32) (-sp4C);
  arg0->unk30 = 0.0f; arg0->unk2C = 0.0f;
...
#pragma GLOBAL_ASM("asm/nonmatchings/srand/func_8002387C.s")
...
#pragma GLOBAL_ASM("asm/nonmatchings/srand/func_80023E80.s")

#pragma GLOBAL_ASM("asm/nonmatchings/srand/func_8002413C.s")
